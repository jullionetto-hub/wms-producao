...
function classificarDia(registros, horario, esperadoPorGrupo, diaSemana) {
  ...
  // menos o horário oficial de saída do turno — positivo = ficou a mais,
  // negativo = saiu antes. Só calcula quando dá pra saber a saída esperada
  // (turno oficial reconhecido, ou mediana do grupo horario|n como fallback).

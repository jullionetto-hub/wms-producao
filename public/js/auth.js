...
function montarSidebar() {
  ...
  const menus = {
    supervisor: `
      ...
      <a class="mi" onclick="irPara('relatorios',this)"><span class="mi-ic">📦</span>Relatrios</a>
      ...
      <a class="mi" onclick="irPara('separacao',this)"><span class="mi-ic">📦</span>Separao</a>
      <a class="mi" onclick="irPara('reposicao',this)"><span class="mi-ic">📦</span>Reposio <span class="mbadge" id="menu-badge-rep" style="display:none">0</span></a>
      <a class="mi" onclick="irPara('checkout',this)"><span class="mi-ic">📦</span>Checkout</a>`,
    separador: `
    ...
    repositor: `
      ...
      <a class="mi ativo" onclick="irPara('reposicao',this)"><span class="mi-ic">📦</span>Solicitaes <span class="mbadge" id="menu-badge-rep" style="display:none">0</span></a>
      <a class="mi" onclick="irPara('checkout',this)"><span class="mi-ic">📦</span>Checkout</a>
      <div class="mg">ANÁLISE</div>
      <a class="mi" onclick="irPara('stats-repositor',this)"><span class="mi-ic">📦</span>Estatsticas</a>`,
    checkout: `
      <div class="mg">CHECKOUT</div>
      <a class="mi ativo" onclick="irPara('checkout',this)"><span class="mi-ic">📦</span>Checkout</a>
      <div class="mg">ANÁLISE</div>
      <a class="mi" onclick="irPara('stats-checkout',this)"><span class="mi-ic">📦</span>Estatsticas</a>`,
  };
